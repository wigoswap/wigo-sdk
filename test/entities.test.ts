    ...
    describe(`decimals permutation: ${decimals}`, () => {
      ...
      describe('Trade', () => {
        ...
        it('TradeType.EXACT_INPUT', () => {
          ...
          const expectedOutputAmount = new TokenAmount(WETH, '1664026941864923892')
          ...
          expect(trade.executionPrice.toSignificant(18)).toEqual('1.66402694186492389')
          expect(trade.executionPrice.invert().toSignificant(18)).toEqual('0.600951808436028454')
          ...
          expect(trade.nextMidPrice.toSignificant(18)).toEqual('1.38932884302251268')
          expect(trade.nextMidPrice.invert().toSignificant(18)).toEqual('0.719772')

          expect(trade.priceImpact.toSignificant(18)).toEqual('16.7986529067538054')
        })

        it('TradeType.EXACT_OUTPUT', () => {
          const outputAmount = new TokenAmount(WETH, '1664026941864923892')
        ...
        it('minimum TradeType.EXACT_INPUT', () => {
          if ([9, 18].includes(tokens[1].decimals)) {
            ...
            expect(trade.priceImpact.toSignificant(18)).toEqual(
              tokens[1].decimals === 9 ? '0.190000102480569898' : '0.3000000000000001'
            )
          }
        })
      })
