...
describe('Pair', () => {
  const USDC = new Token(ChainId.MAINNET, '0xfaFedb041c0DD4fA2Dc0d87a6B0979Ee6FA7af5F', 18, 'USDC', 'USD Coin')
  const DAI = new Token(ChainId.MAINNET, '0x8D11eC38a3EB5E956B052f67Da8Bdc9bef8Abf3E', 18, 'DAI', 'DAI Stablecoin')
